...
SRC_URI += "${@bb.utils.contains("IMAGE_CLASSES", "avb-verity", \
           ...
           " file://dm-verity-verify.cfg \
             file://v6.6/0001-dm-verity-add-CONFIG_DM_VERITY_REQUIRE_ROOTHASH_SIG.patch \
             file://v6.6/0002-dm-verity-add-root_hash_sig_hex-optional-parameter.patch \
             file://v6.6/0003-params-raise-charp-parameter-length-limit.patch" \
            , "" ,d), "" ,d)}"
